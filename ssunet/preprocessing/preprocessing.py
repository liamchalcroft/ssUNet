...
from ssunet.configuration import default_num_threads, RESAMPLING_SEPARATE_Z_ANISO_THRESHOLD
from ssunet.preprocessing.cropping import get_case_identifier_from_npz, ImageCropper
...
class GenericPreprocessor(object):
    ...
    def preprocess_test_case(self, data_files, target_spacing, seg_file=None, force_separate_z=None):
        ...
        seg = seg.transpose((0, *[i + 1 for i in self.transpose_forward])) if seg is not None else None
