...
from ssunet.inference.predict import predict_from_folder
from ssunet.paths import default_plans_identifier, network_training_output_dir, default_cascade_trainer, default_trainer
...
def main():
    ...
    parser.add_argument('-tr', '--trainer_class_name',
                        help='Name of the Trainer used for 2D U-Net, full resolution 3D U-Net and low resolution '
