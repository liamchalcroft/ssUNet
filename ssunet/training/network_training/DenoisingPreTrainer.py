...
import numpy as np
import torch
from ssunet.training.data_augmentation.data_augmentation_denoising import (
    get_denoising_augmentation,
)
...
class DenoisingPreTrainer(NetworkPreTrainer):
    ...
    def __init__(
        ...
        self.skip = (
            skip  # whether to use skip-connections - DDeP doesnt use skip connection...
        )
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            if training:
                ...
                self.tr_gen = get_denoising_augmentation(
                    self.dl_tr,
    ...
    def process_plans(self, plans):
        ...
        self.num_classes = (
            1 if self.noisevec else plans["num_modalities"]
        )  # dont need actual number, just enough for 1:1 noise or image mapping
